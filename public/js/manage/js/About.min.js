			...
			return (
				React.createElement("div", {className: "area-for-content"}, 
					React.createElement("div", {className: "padding-area"}, 
						React.createElement("button", {onClick: this.props.addText, className: "button button-no-with"}, "Добавить текст"), 
						React.createElement("p", {className: "-or"}, "или"), 
						React.createElement("label", {htmlFor: "hidden_file", className: "button button-no-with", name: this.props.name}, 
			...
			return (
				React.createElement("div", {className: "area-for-content", name: this.props.name}, 
					...
					React.createElement("form", {className: "to-text-form", onSubmit: this.props.contentUpgrade}, 
						...
						React.createElement("textarea", {className: "area-of-text", name: "description"}), 
						React.createElement("input", {type: "hidden", name: "number", value: this.props.name}), 
						React.createElement("button", {type: "submit", className: "button button-no-with"}, "Сохранить")
					)
				)
			)
		}
