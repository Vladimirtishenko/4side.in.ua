			...
			React.createElement("div", {className: "block-for-slides-campany"}, 
				React.createElement("div", {className: "to-text-form"}, 
					React.createElement("form", {className: "to-text-form-inner", onSubmit: this.props.saveInfo}, 
						...
						React.createElement("textarea", {rows: "5", className: "area-of-text", name: "description_en", placeholder: "Description English", defaultValue: data.description_en || "", required: true}), 
						React.createElement("textarea", {rows: "5", className: "area-of-text", name: "description_ru", placeholder: "Описание на русском", defaultValue: data.description_ru || "", required: true}), 
