var Team = React.createClass({displayName: "Team",
	render: function () {
		var ArrayTeam = this.props.content.team.length > 0 ? this.props.content.team.map(function(item, i){
			return React.createElement(TemplateTeam, {data: item, context: TemplateWithoutInput})
		}): null;
		return (
...
var TemplateTeam = React.createClass({displayName: "TemplateTeam",
	...
	render: function(){	
		if(this.props.data == this.state.data)	{
			return (React.createElement(this.state.context, {replace: this.replaceTemplate, data: this.state.data}));
		} else {
			return (React.createElement(this.props.context, {replace: this.replaceTemplate, data: this.props.data}));
		}
	}	
})
