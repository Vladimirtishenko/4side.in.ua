var Team = React.createClass({displayName: "Team",
	...
	render: function () {
		var ArrayTeam = this.state.content.length > 0 ? this.state.content.map(function(item, i){
			return React.createElement(TemplateTeam, {key: i, data: item, lang: this.state.lang, context: TemplateWithoutInput})
		}.bind(this)): null;
...
var TemplateTeam = React.createClass({displayName: "TemplateTeam",
	...
	render: function(){	
		return (React.createElement(this.state.context, {delets: this.deleteItem, replace: this.replaceTemplate, lang: this.props.lang, data: this.state.data}));
	}	
})
		...
		return (
			React.createElement("div", {className: "outer-of-team"}, 
				...
				React.createElement("form", {onSubmit: this.addNewUser, className: "for-for-team-edit-or-add"}, 
					...
					React.createElement("input", {type: "text", name: "name_ru", placeholder: "Имя на русском", defaultValue: this.props.data ? this.props.data.name_ru : "", required: "required"}), 
					React.createElement("input", {type: "text", name: "name_en", placeholder: "Имя на английском", defaultValue: this.props.data ? this.props.data.name_en : "", required: "required"}), 
					...
					React.createElement("input", {type: "text", name: "description_ru", placeholder: "Описание на русском", defaultValue: this.props.data ? this.props.data.description_ru : "", required: "required"}), 
					React.createElement("input", {type: "text", name: "description_en", placeholder: "Описание на английском", defaultValue: this.props.data ? this.props.data.description_en : "", required: "required"}), 
