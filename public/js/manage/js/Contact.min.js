					...
					React.createElement("form", {onSubmit: this.editContact}, 
						React.createElement("div", {className: "outer-table"}, 
							...
							React.createElement("div", {className: "right-to-desctiption"}, 
								...
								React.createElement("input", {type: "text", className: "description-portfolio", name: "adress_en", placeholder: "Адресс", defaultValue: data.adress_en, required: "required"}), 
								React.createElement("input", {type: "text", className: "description-portfolio", name: "adress_ru", placeholder: "Адресс", defaultValue: data.adress_ru, required: "required"}), 
