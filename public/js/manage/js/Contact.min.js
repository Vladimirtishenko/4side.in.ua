					...
					React.createElement("form", {onSubmit: this.editContact}, 
						React.createElement("div", {className: "outer-table"}, 
							...
							React.createElement("div", {className: "right-to-desctiption"}, 
								...
								React.createElement("input", {type: "text", className: "title-portfolio", name: "phone", placeholder: "Телефоны", defaultValue: data.phone || "", required: "required"}), 
								React.createElement("input", {type: "text", className: "description-portfolio", name: "adress_ru", placeholder: "Адресс на русском", defaultValue: data.adress_ru || "", required: "required"}), 
								React.createElement("input", {type: "text", className: "description-portfolio", name: "adress_en", placeholder: "Адресс на английском", defaultValue: data.adress_en || "", required: "required"}), 
