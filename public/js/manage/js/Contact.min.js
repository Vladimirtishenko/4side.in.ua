var Contact = React.createClass({displayName: "Contact",
	...
	render: function () {
		...
		return (
			React.createElement(this.state.template, {title: this.props.title, translator: this.state.translator, edit: this.edit, lang: this.state.lang, getData: data})
		);
	}
				...
				React.createElement("div", {className: "outer-members"}, 
					React.createElement("i", {className: "fa fa-pencil edit-about-block", onClick: this.props.edit}), 
						React.createElement("div", {className: "area-for-content"}, 
							React.createElement("div", {className: "area-for-content__helpers"}, 
								phones, 
								adress, 
						...
						React.createElement("div", {className: "area-for-content"}, 
							React.createElement("img", {src: data.src ? data.src : '/images/map_image_template.gif'})
						)
				)
			)
		);
		...
		return (
			React.createElement("div", {className: "Contact height-full"}, 
				...
				React.createElement("div", {className: "outer-levels-step padding-block"}, 
					React.createElement("form", {onSubmit: this.editContact}, 
						React.createElement("div", {className: "outer-table"}, 
							...
							React.createElement("div", {className: "right-to-desctiption"}, 
								React.createElement("p", null, translator.PHONE_RULES), 
								React.createElement("input", {type: "hidden", name: "id", defaultValue: data._id}), 
								React.createElement("input", {type: "text", className: "title-portfolio", name: "phone", placeholder: translator.PHONE, defaultValue: data.phone || "", required: "required"}), 
								React.createElement("input", {type: "text", className: "description-portfolio", name: "adress_ru", placeholder: translator.ADRESS_RU, defaultValue: data.adress_ru || "", required: "required"}), 
								React.createElement("input", {type: "text", className: "description-portfolio", name: "adress_en", placeholder: translator.ADRESS_EN, defaultValue: data.adress_en || "", required: "required"}), 
					...
					React.createElement("button", {type: "submit", className: "button button-center"}, translator.SAVE)
					)
				)
			)
		);
