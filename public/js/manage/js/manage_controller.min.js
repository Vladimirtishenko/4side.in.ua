		...
		render: function () {
			var MenuArray = this.props.menu ? this.props.menu : null,
				Menu = MenuArray ? MenuArray.map(function (item, i) {
					return item.active ? React.createElement("li", {key: i, className: "active-list"}, React.createElement("span", null, item.name_rus)) : React.createElement("li", {key: i}, React.createElement("a", {onClick: this.props.context, name: item.context, "data-rus-title": item.name_rus, href: "#"}, item.name_rus))
				}, this) : null;
