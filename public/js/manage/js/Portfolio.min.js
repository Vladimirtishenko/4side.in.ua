	...
	render: function () {
		return (
			React.createElement("div", {className: "Portfolio height-full"}, 
				...
				React.createElement(this.state.template, {id: this.state.id, data: this.state.content, translator: this.state.translator, lang: this.state.lang, change: this.changeTemplate})
			)
		)
	}
});
...
var PortfolioAddTemplate = React.createClass({displayName: "PortfolioAddTemplate",
				...
				React.createElement("div", {className: "outer-to-add"}, 
					React.createElement("div", {className: "outer-levels-step"}, 
						...
						React.createElement("div", {className: "right-to-desctiption"}, 
							...
							React.createElement("input", {type: "text", className: "origin-portfolio", name: "origin_ru", placeholder: translator.FEAUTURES_RU, required: "required"}), 
							React.createElement("input", {type: "text", className: "origin-portfolio", name: "origin_en", placeholder: translator.FEAUTURES_EN, required: "required"})
						)
					), 
...
var PortfolioEditTemplate = React.createClass({displayName: "PortfolioEditTemplate",
				...
				React.createElement("div", {className: "outer-to-add"}, 
					React.createElement("div", {className: "outer-levels-step"}, 
						React.createElement("div", {className: "right-to-desctiption"}, 
							...
							React.createElement("input", {type: "text", className: "origin-portfolio", name: "origin_ru", placeholder: translator.FEAUTURES_RU, defaultValue: data.origin_ru, required: "required"}), 
							React.createElement("input", {type: "text", className: "origin-portfolio", name: "origin_en", placeholder: translator.FEAUTURES_EN, defaultValue: data.origin_en, required: "required"})
						)
					), 
					React.createElement("button", {className: "save-form button", type: "submit"}, translator.SAVE)
				)
