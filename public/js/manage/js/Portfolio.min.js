	...
	render: function () {
		return (
			React.createElement("div", {className: "Portfolio height-full"}, 
				...
				this.state.template ? React.createElement(this.state.template, {change: this.changeTemplate}) : React.createElement(MainTemplateTable, null)
			)
		)
	}
});
	...
	render: function(){
		return(
			React.createElement("div", {className: "outer-tebles"}, 
				React.createElement("button", {onClick: this.props.change, className: "btn btn-info add-portfolio"}, "Добавить работу"), 
	...
	addPhoto: function(event, files){
		...
		for (var i = 0; i < Files.length; i++) {
			...
			return function(e) {
				...
				self.state.imagesContent.push(React.createElement("span", {name: Random}, React.createElement("img", {src: e.target.result}), React.createElement("i", {onClick: self.deletePhoto})));
		...
		return (
			React.createElement("form", {onSubmit: this.addFormGalery}, 
				React.createElement("div", {className: "outer-to-add"}, 
					React.createElement("div", {className: "outer-levels-step"}, 
						React.createElement("div", {className: "left-to-gen-image"}, 
							React.createElement("label", {htmlFor: "hidden_file"}, 
								React.createElement("img", {className: "add-gen-photo", src: this.state.imagesTemp}), 
								React.createElement("input", {onChange: this.tempImageToGallery, type: "file", name: "upload", id: "hidden_file"})
							)
						), 
						React.createElement("div", {className: "right-to-desctiption"}, 
							React.createElement("input", {type: "text", className: "title-portfolio", name: "title", placeholder: "Название проекта"}), 
							React.createElement("input", {type: "text", className: "description-portfolio", name: "description", placeholder: "Описание проекта"}), 
							React.createElement("input", {type: "text", className: "technology-portfolio", name: "technology", placeholder: "Технологии"}), 
							React.createElement("input", {type: "text", className: "origin-portfolio", name: "origin", placeholder: "Особенности"})
						)
					), 
					...
					React.createElement("button", {className: "save-form btn btn-info", type: "submit"}, "Сохранить")
				)
			)
		);
	}
