	...
	render: function () {
		return (
			React.createElement("div", {className: "Portfolio height-full"}, 
				...
				this.state.template ? React.createElement(this.state.template, {data: this.state.content, lang: this.state.lang, change: this.changeTemplate}) : React.createElement(MainTemplateTable, {lang: this.state.lang, data: this.state.content})
			)
		)
	}
});
